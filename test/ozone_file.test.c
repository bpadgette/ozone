...
void shouldLoadFileFromPath(void) {
  OzoneStringVector chunks = ozoneFileLoadFromPath(test_alloc, &ozoneString("./test/resources/content.txt"), 100);
...
void shouldLoadFileChunksFromPath(void) {
  OzoneStringVector chunks = ozoneFileLoadFromPath(test_alloc, &ozoneString("./test/resources/content.txt"), 10);
