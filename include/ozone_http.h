...
OzoneHTTPHeadersT* ozoneHTTPHeadersSetHeaders(OzoneAllocatorT* alloc, OzoneHTTPHeadersT* headers, OzoneCharArrayT* keys,
    OzoneCharArrayT* values, size_t set_count);
